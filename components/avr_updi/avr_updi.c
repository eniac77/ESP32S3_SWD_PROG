...
typedef struct {
    ...
    uint8_t  nvm_ver;      /* 0 = v0 (tiny/mega0), 2 = v2 (AVR Dx), 3 = v3/v4 (AVR Ex, csak detekt) */
    bool     addr24;       /* true: 24-bites ST-pointer (AVR Dx/Ex) */
} updi_known_t;

/* pymcuprog deviceinfo-hoz igazítva (signature/flash/lap/base/verzió). */
static const updi_known_t UPDI_TABLE[] = {
    { { 0x1E, 0x91, 0x20 }, "ATtiny214", 0x800, 64, 0x8000, 0, false },
    { { 0x1E, 0x91, 0x21 }, "ATtiny212", 0x800, 64, 0x8000, 0, false },
    { { 0x1E, 0x91, 0x22 }, "ATtiny204", 0x800, 64, 0x8000, 0, false },
    { { 0x1E, 0x91, 0x23 }, "ATtiny202", 0x800, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x20 }, "ATtiny417", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x21 }, "ATtiny416", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x22 }, "ATtiny414", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x23 }, "ATtiny412", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x25 }, "ATtiny406", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x26 }, "ATtiny404", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x27 }, "ATtiny402", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x28 }, "ATtiny416auto", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x2A }, "ATtiny427", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x2B }, "ATtiny426", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x92, 0x2C }, "ATtiny424", 0x1000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x20 }, "ATtiny817", 0x2000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x21 }, "ATtiny816", 0x2000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x22 }, "ATtiny814", 0x2000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x23 }, "ATtiny807", 0x2000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x24 }, "ATtiny806", 0x2000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x25 }, "ATtiny804", 0x2000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x26 }, "ATmega808", 0x2000, 64, 0x4000, 0, false },
    { { 0x1E, 0x93, 0x27 }, "ATtiny827", 0x2000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x28 }, "ATtiny826", 0x2000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x29 }, "ATtiny824", 0x2000, 64, 0x8000, 0, false },
    { { 0x1E, 0x93, 0x2A }, "ATmega809", 0x2000, 64, 0x4000, 0, false },
    { { 0x1E, 0x93, 0x2B }, "AVR8EA32", 0x2000, 64, 0x800000, 3, true },
    { { 0x1E, 0x93, 0x2C }, "AVR8EA28", 0x2000, 64, 0x800000, 3, true },
    { { 0x1E, 0x94, 0x20 }, "ATtiny1617", 0x4000, 64, 0x8000, 0, false },
    { { 0x1E, 0x94, 0x21 }, "ATtiny1616", 0x4000, 64, 0x8000, 0, false },
    { { 0x1E, 0x94, 0x22 }, "ATtiny1614", 0x4000, 64, 0x8000, 0, false },
    { { 0x1E, 0x94, 0x23 }, "ATtiny1607", 0x4000, 64, 0x8000, 0, false },
    { { 0x1E, 0x94, 0x24 }, "ATtiny1606", 0x4000, 64, 0x8000, 0, false },
    { { 0x1E, 0x94, 0x25 }, "ATtiny1604", 0x4000, 64, 0x8000, 0, false },
    { { 0x1E, 0x94, 0x26 }, "ATmega1609", 0x4000, 64, 0x4000, 0, false },
    { { 0x1E, 0x94, 0x27 }, "ATmega1608", 0x4000, 64, 0x4000, 0, false },
    { { 0x1E, 0x94, 0x28 }, "ATtiny1627", 0x4000, 64, 0x8000, 0, false },
    { { 0x1E, 0x94, 0x29 }, "ATtiny1626", 0x4000, 64, 0x8000, 0, false },
    { { 0x1E, 0x94, 0x2A }, "ATtiny1624", 0x4000, 64, 0x8000, 0, false },
    { { 0x1E, 0x94, 0x31 }, "AVR16DD32", 0x4000, 512, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x32 }, "AVR16DD28", 0x4000, 512, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x33 }, "AVR16DD20", 0x4000, 512, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x34 }, "AVR16DD14", 0x4000, 512, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x35 }, "AVR16EA48", 0x4000, 64, 0x800000, 3, true },
    { { 0x1E, 0x94, 0x36 }, "AVR16EA32", 0x4000, 64, 0x800000, 3, true },
    { { 0x1E, 0x94, 0x37 }, "AVR16EA28", 0x4000, 64, 0x800000, 3, true },
    { { 0x1E, 0x94, 0x38 }, "AVR16DU32", 0x4000, 512, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x39 }, "AVR16DU28", 0x4000, 512, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x3A }, "AVR16DU20", 0x4000, 512, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x3B }, "AVR16DU14", 0x4000, 512, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x3E }, "AVR16EB32", 0x4000, 64, 0x800000, 3, true },
    { { 0x1E, 0x94, 0x3F }, "AVR16EB28", 0x4000, 64, 0x800000, 3, true },
    { { 0x1E, 0x94, 0x40 }, "AVR16EB20", 0x4000, 64, 0x800000, 3, true },
    { { 0x1E, 0x94, 0x49 }, "AVR16EB14", 0x4000, 64, 0x800000, 3, true },
    { { 0x1E, 0x94, 0x51 }, "AVR16LA32", 0x4000, 64, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x52 }, "AVR16LA28", 0x4000, 64, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x53 }, "AVR16LA20", 0x4000, 64, 0x800000, 2, true },
    { { 0x1E, 0x94, 0x54 }, "AVR16LA14", 0x4000, 64, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x21 }, "ATtiny3216", 0x8000, 128, 0x8000, 0, false },
    { { 0x1E, 0x95, 0x22 }, "ATtiny3217", 0x8000, 128, 0x8000, 0, false },
    { { 0x1E, 0x95, 0x26 }, "ATtiny3227", 0x8000, 128, 0x8000, 0, false },
    { { 0x1E, 0x95, 0x27 }, "ATtiny3226", 0x8000, 128, 0x8000, 0, false },
    { { 0x1E, 0x95, 0x28 }, "ATtiny3224", 0x8000, 128, 0x8000, 0, false },
    { { 0x1E, 0x95, 0x29 }, "AVR32LA14", 0x8000, 64, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x2A }, "AVR32EB32", 0x8000, 64, 0x800000, 3, true },
    { { 0x1E, 0x95, 0x2B }, "AVR32EB28", 0x8000, 64, 0x800000, 3, true },
    { { 0x1E, 0x95, 0x2C }, "AVR32EB20", 0x8000, 64, 0x800000, 3, true },
    { { 0x1E, 0x95, 0x2D }, "AVR32EB14", 0x8000, 64, 0x800000, 3, true },
    { { 0x1E, 0x95, 0x30 }, "ATmega3208", 0x8000, 128, 0x4000, 0, false },
    { { 0x1E, 0x95, 0x31 }, "ATmega3209", 0x8000, 128, 0x4000, 0, false },
    { { 0x1E, 0x95, 0x32 }, "AVR32DA48", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x33 }, "AVR32DA32", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x34 }, "AVR32DA28", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x35 }, "AVR32DB48", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x36 }, "AVR32DB32", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x37 }, "AVR32DB28", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x38 }, "AVR32DD32", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x39 }, "AVR32DD28", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x3A }, "AVR32DD20", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x3B }, "AVR32DD14", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x3C }, "AVR32EA48", 0x8000, 64, 0x800000, 3, true },
    { { 0x1E, 0x95, 0x3D }, "AVR32EA32", 0x8000, 64, 0x800000, 3, true },
    { { 0x1E, 0x95, 0x3E }, "AVR32EA28", 0x8000, 64, 0x800000, 3, true },
    { { 0x1E, 0x95, 0x3F }, "AVR32DU32", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x40 }, "AVR32DU28", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x4E }, "AVR32DU20", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x4F }, "AVR32DU14", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x52 }, "AVR32SD32", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x53 }, "AVR32SD28", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x54 }, "AVR32SD20", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x58 }, "AVR32LA32", 0x8000, 64, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x59 }, "AVR32LA28", 0x8000, 64, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x60 }, "AVR32LA20", 0x8000, 64, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x70 }, "AVR32DA48S", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x71 }, "AVR32DA32S", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x95, 0x72 }, "AVR32DA28S", 0x8000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x12 }, "AVR64DA64", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x13 }, "AVR64DA48", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x14 }, "AVR64DA32", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x15 }, "AVR64DA28", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x16 }, "AVR64DB64", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x17 }, "AVR64DB48", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x18 }, "AVR64DB32", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x19 }, "AVR64DB28", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x1A }, "AVR64DD32", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x1B }, "AVR64DD28", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x1C }, "AVR64DD20", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x1D }, "AVR64DD14", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x1E }, "AVR64EA48", 0x10000, 128, 0x800000, 3, true },
    { { 0x1E, 0x96, 0x1F }, "AVR64EA32", 0x10000, 128, 0x800000, 3, true },
    { { 0x1E, 0x96, 0x20 }, "AVR64EA28", 0x10000, 128, 0x800000, 3, true },
    { { 0x1E, 0x96, 0x21 }, "AVR64DU32", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x22 }, "AVR64DU28", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x2B }, "AVR64DA64S", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x2C }, "AVR64DA48S", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x2D }, "AVR64DA32S", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x2E }, "AVR64DA28S", 0x10000, 512, 0x800000, 2, true },
    { { 0x1E, 0x96, 0x50 }, "ATmega4808", 0xC000, 128, 0x4000, 0, false },
    { { 0x1E, 0x96, 0x51 }, "ATmega4809", 0xC000, 128, 0x4000, 0, false },
    { { 0x1E, 0x97, 0x07 }, "AVR128DA64", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x08 }, "AVR128DA48", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x09 }, "AVR128DA32", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x0A }, "AVR128DA28", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x0B }, "AVR128DB64", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x0C }, "AVR128DB48", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x0D }, "AVR128DB32", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x0E }, "AVR128DB28", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x0F }, "AVR128DA64S", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x10 }, "AVR128DA48S", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x11 }, "AVR128DA32S", 0x20000, 512, 0x800000, 2, true },
    { { 0x1E, 0x97, 0x12 }, "AVR128DA28S", 0x20000, 512, 0x800000, 2, true },
};
...
esp_err_t avr_updi_flash_file(const char *path, avr_updi_progress_cb cb, void *ctx)
{
    ...
    /* A flash-út csak NVMCTRL v0/v2-t támogat. Az AVR Ex (v3/v4) detektálható
       (nevet mutat), de a programozása még nincs bekötve — tiszta hibával állunk le. */
    if (k->nvm_ver != 0 && k->nvm_ver != 2) {
        ESP_LOGE(TAG, "NVMCTRL v%u (AVR Ex) flashelese meg nem tamogatott", k->nvm_ver);
